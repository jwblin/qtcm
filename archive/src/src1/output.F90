! This file contains most of the output subroutines for qtcm model
!   (varmean is in a separate file)
!
...
Subroutine ncInit(ncfnm,nlon,nlat,ismean)
  ...
  Character (LEN=130), Intent (OUT)  :: ncfnm     ! netCDF file name
...
Subroutine writeStype(ncfnm)
  ...
  Character (LEN=130), Intent (IN) :: ncfnm
...
Subroutine printError(routine,iret)
  ...
  Character (len=130)   :: error_string
