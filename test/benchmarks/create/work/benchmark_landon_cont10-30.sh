#!/bin/csh
# QTCM model benchmark run:  land on, 15 days, daily mean and
...
set OLDOUT    = $QTCMROOT/proc/${RUNNAME}_old  #Old output directory
...
# ----------------------------------------------
#
cp -fp $OLDOUT/qtcm*restart .
mv qtcm_00011110.restart qtcm.restart
cp -fp $SRCDIR/qtcm .
...
cd $OUTDIR
cd ..
mv ./${RUNNAME}_old ./${RUNNAME}_10
mv ./${RUNNAME} ./${RUNNAME}_30

cd ./${RUNNAME}_10
mv qi_${RUNNAME}.nc qi_${RUNNAME}_10.nc
mv qm_${RUNNAME}.nc qm_${RUNNAME}_10.nc
mv ${RUNNAME}.log ${RUNNAME}_10.log

cd ..

cd ./${RUNNAME}_30
mv qi_${RUNNAME}.nc qi_${RUNNAME}_30.nc
mv qm_${RUNNAME}.nc qm_${RUNNAME}_30.nc
mv ${RUNNAME}.log ${RUNNAME}_30.log
