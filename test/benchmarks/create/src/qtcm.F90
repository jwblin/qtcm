...
#else
        Call Save_bartr !save u0,v0 for surface geopotential
        Call bartr      !barotropic mode
        Call grad_phis  !surface geopotential gradient
#endif
     End If
